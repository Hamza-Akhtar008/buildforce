...
export function JobApplicationForm({ job }: JobApplicationFormProps) {
  ...
  const handleFileUpload = (field: "resume" | "certificates_files", file: File) => {
    if (field === "resume") {
  ...
  const removeFile = (field: "resume" | "certificates_files", index?: number) => {
    if (field === "resume") {
      setFormData((prev) => ({ ...prev, resume: null }))
    } else if (index !== undefined) {
      setFormData((prev) => ({
        ...prev,
        certificates_files: prev.certificates_files.filter((_, i) => i !== index),
      }))
    }
  }
    ...
    return (
      <div className="text-center py-12">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Button onClick={() => (window.location.href = "/")}>Browse More Jobs</Button>
        </div>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="work-permit">Work Permit Holder</SelectItem>
                <SelectItem value="student-permit">Student Permit</SelectItem>
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => handleInputChange("requiresVisa", checked)}
            />
            <Label htmlFor="requiresVisa">I require visa sponsorship</Label>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <Label htmlFor="yearsExp">Years of Experience in Construction/Labour *</Label>
            <Select
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {["Day", "Night", "Flexible"].map((shift) => (
                <Badge
                  key={shift}
                  variant={formData.availableShifts.includes(shift.toLowerCase()) ? "default" : "outline"}
                  className="cursor-pointer"
                  onClick={() => handleShiftToggle(shift.toLowerCase())}
                >
                  {shift}
                </Badge>
              ))}
          ...
          <div>
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="company-transport">Company Transportation</SelectItem>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Benefits & Accommodation</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="needsAccommodation">I need accommodation/housing assistance</Label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleInputChange("needsTransport", checked)}
              />
              <Label htmlFor="needsTransport">I need transportation assistance</Label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleInputChange("needsMeals", checked)}
              />
              <Label htmlFor="needsMeals">I would like meal provisions</Label>
            </div>
          </div>
        </CardContent>
      </Card>
            ...
            <div className="mt-2 space-y-2">
              {formData.certificates_files.map((file, index) => (
                <div key={index} className="flex items-center justify-between p-3 border border-border rounded-md">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    onClick={() => removeFile("certificates_files", index)}
                  >
                    <X className="h-4 w-4" />
                  </Button>
                </div>
              ...
              <div className="border-2 border-dashed border-border rounded-md p-4 text-center">
                ...
                <input
                  ...
                  onChange={(e) => {
                    const file = e.target.files?.[0]
                    if (file) handleFileUpload("certificates_files", file)
                  }}
                  className="hidden"
                  id="cert-upload"
                />
        ...
        <CardContent className="space-y-4">
          <div className="flex items-start space-x-2">
            ...
            <Label htmlFor="agreeTerms" className="text-sm leading-relaxed">
              I agree to the Terms of Service and Privacy Policy. I understand that my information will be shared with
              the employer for this application. *
            </Label>
          </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <Label htmlFor="agreeBackground" className="text-sm leading-relaxed">
              I consent to background checks and reference verification as required by the employer. *
            </Label>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="flex justify-end">
        <Button
          type="submit"
          size="lg"
          disabled={isSubmitting || !formData.agreeToTerms || !formData.agreeToBackground}
          className="px-8"
        >
