  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-6 max-w-6xl">
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-balance mb-2">My Projects</h1>
          <p className="text-muted-foreground">Select a project to view detailed attendance records</p>
        </div>
