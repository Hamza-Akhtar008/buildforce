                     ...
                     <CardHeader className="pb-3 lg:pb-4">
                        <div className="flex flex-col gap-3 lg:gap-4">
                           <div className="flex-1">
                              <h1 className="text-xl lg:text-2xl font-bold text-foreground text-balance">
                                 {job.title}
                              </h1>
                     ...
                     <CardContent>
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                           ...
                           >
                              <Utensils
                                 className={`h-5 w-5 ${
                                    job.benefits.meals ? "text-accent" : ""
                                 }`}
                              />
                           ...
                           >
                              <Car
                                 className={`h-5 w-5 ${
                                    job.benefits.transport ? "text-accent" : ""
                                 }`}
                              />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                           <div className="space-y-2">
                              ...
                              <p className="text-muted-foreground ml-6">
                                 {job.practical_info.workingHours}
                              </p>
                           </div>
                           <div className="space-y-2">
                              <div className="flex items-center gap-2">
                  ...
                  <Card className="bg-card border-border">
                     <CardContent className="p-4 lg:p-6 space-y-3">
                        <Link href={`/jobs/${job.id}/apply`}>
                           <Button
                              className="w-full cursor-pointer bg-primary text-primary-foreground hover:bg-primary/90 mb-3"
                              size="lg"
                           >
                              Apply Now
                           </Button>
                        ...
                        <Button
                           variant="secondary"
                           className="w-full bg-secondary text-secondary-foreground cursor-pointer"
                           size="lg"
                        >
                        ...
                        <Button
                           variant="outline"
                           className="w-full cursor-pointer border-ring text-foreground hover:bg-accent bg-transparent"
                           size="lg"
                        >
                  ...
                  <Card className="bg-card border-border">
                     ...
                     <CardContent className="space-y-3">
                        {mockJobs
                           .filter(
                              (j) =>
                                 j.id !== job.id && j.jobType === job.jobType
                           )
                           .slice(0, 3)
                           .map((similarJob) => (
                              <Link
