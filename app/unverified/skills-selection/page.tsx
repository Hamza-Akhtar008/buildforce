...
export default function SkillsSelectionPage() {
   ...
   const handleNext = () => {
      if (currentScreen === 3 && selectedSkillLevel === "need_training") {
         // Skip step 4 if user needs training
   ...
   const canProceed = () => {
      if (currentScreen === 1) return selectedRole !== "";
      if (currentScreen === 2) return selectedTrades.length > 0;
      if (currentScreen === 3) return selectedSkillLevel !== "";
      if (currentScreen === 4) return selectedExperience !== "";
   ...
   const getScreenDescription = () => {
      switch (currentScreen) {
         case 1:
            return "Choose the role that best describes your professional position";
         case 2:
            ...
            return (
               <div className="text-center py-16">
                  ...
                  <p className="text-muted-foreground text-lg">
                     Content for {getScreenTitle().toLowerCase()} will be added
                     here
                  </p>
               </div>
            );
                  ...
                  <div className="w-80">
                     <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs font-medium text-primary">
                           {Math.round((currentScreen / totalScreens) * 100)}%
                           Complete
                        </span>
                     </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-6">
               <div className="flex items-center justify-between w-full">
                  <Button
                     ...
                     className="flex cursor-pointer items-center space-x-2 disabled:opacity-50"
                  >
                  ...
                  >
                     <span>
                        ...
                        (currentScreen === 3 &&
                           selectedSkillLevel === "need_training")
                           ? "Complete Setup"
                           : "Next Step"}
                     </span>
