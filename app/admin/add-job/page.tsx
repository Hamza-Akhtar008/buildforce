...
const page = () => {
  ...
  return (
    <div className="w-full px-2 sm:px-4 md:px-8 lg:px-0 flex justify-center">
      <Card className="w-full max-w-2xl lg:max-w-6xl  text-white border border-[#444] my-8">
        <CardHeader>
        ...
        <CardContent>
          <div className="space-y-4">
            <label htmlFor="jobTitle" className="block text-sm font-medium text-white mb-1">Job Title</label>
            <Input
              id="jobTitle"
              name="jobTitle"
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <div className="w-full">
                <label htmlFor="level" className="block text-sm font-medium text-white mb-1">Level</label>
                <Select value={level} onValueChange={setLevel}>
                  <SelectTrigger id="level" className="bg-[#232323] border border-[#444] text-white w-full" name="level">
              ...
              <div className="w-full">
                <label htmlFor="shift" className="block text-sm font-medium text-white mb-1">Shift</label>
                <Input
                  id="shift"
                  name="shift"
                  className="bg-[#232323] border border-[#444] text-white placeholder:text-[#aaa] w-full"
            ...
            <label htmlFor="salary" className="block text-sm font-medium text-white mb-1">Salary</label>
            <Input
              id="salary"
              name="salary"
            ...
            />
            <label htmlFor="description" className="block text-sm font-medium text-white mb-1">Job Description</label>
            <textarea
              id="description"
              name="description"
            ...
            />
            <label htmlFor="requirements" className="block text-sm font-medium text-white mb-1">Requirements</label>
            <textarea
              id="requirements"
              name="requirements"
            ...
            />
            <label htmlFor="benefits" className="block text-sm font-medium text-white mb-1">Benefits</label>
            <textarea
              id="benefits"
              name="benefits"
              className="bg-[#3d3d3d] border border-[#444] text-white placeholder:text-[#aaa] w-full rounded-md p-2 min-h-[60px] resize-y"
